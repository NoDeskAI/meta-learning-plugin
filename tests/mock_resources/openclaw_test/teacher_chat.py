#!/usr/bin/env python3
"""Mock teacher_chat.py for local AB pipeline verification."""
...
def _done_count(total: int, group_a: bool, stage_formal: bool, round_idx: int) -> int:
    ...
    base = total - (3 if stage_formal else 1)
    return max(0, base)
...
def main() -> None:
    ...
    print("#" * 60)
    print(f"# Summary: {done}/{args.num_problems} problems graded within turn limit")
    print("#" * 60)
