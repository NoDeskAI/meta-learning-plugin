...
detection_channels:                   # 多标签检测通道（可同时触发多个）
  - "self_recovery"                   # user_correction | self_recovery | unresolved_error | new_tool | efficiency_anomaly
primary_channel: "self_recovery"      # detection_channels 中优先级最高者
